...
async def run_once():
    ...
    if prompt:
        ...
        prompt += "以下无需回复：现在你是一个活泼热情的记者。在之后跟我的对话中向我提问四个问题，分开提问。提问后做出简要反馈并提出下一个问题。最后在所有四个提问结束后结合提问的内容和回答主动继续对话。第一次向我提问：“你知道哪些关于十五五规划的事情？”第二次向我提问：基于‘十四五’期间在高质量发展，比如新质生产力领域取得的成就，您认为‘十五五’规划将如何在继承与创新之间寻找平衡？”第三次和第四次提问按照之前的提问和回答智能提问。"
