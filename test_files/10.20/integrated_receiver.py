...
class IntegratedReceiver:
    ...
    def __init__(self, emotion_host="127.0.0.1", emotion_port=5555,
                 voice_host="127.0.0.1", voice_port=5557):
        # 表情接收器
    ...
    def start(self):
        ...
        try:
            ...
            print(f"[IntegratedReceiver] 已启动：表情端口 {self.emotion_receiver.port}，关键词端口 {self.voice_port}")
    ...
    def get_detailed_status(self):
        ...
        with self._lock:
            ...
            hold_remaining = max(
                0.0, self._command_hold_secs - (current_time - self._last_cmd_ts)
