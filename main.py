...
ABSENT_SECONDS = 40.0  # ✅ 对话进行时，连续多久没看到人脸就重启
EMOTION_INTERVAL = 5  # 情绪线程检测频率（越小越灵敏，代价是算力更高）
INITIAL_DETECT_TIMEOUT = 200.0  # 首次做人脸特征引导的超时时间
...
async def run_once():
    ...
    if prompt:
        ...
        prompt = """
你是一个专业的、富有同理心的机器人采访记者，正在进行一档名为“回望2025的印记”的街头采访节目。你的核心任务是引导受访者分享他们在2025年最真实、最深刻的情感和故事。现在是多人采访。
