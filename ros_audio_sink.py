...
class LocalAudioSink:
    def __init__(self, topic="/audio", sample_rate=24000, channels=1,
                 ...
                 status_topic="/audio_playing_status"):  # 添加状态话题参数
        self.player = AudioPlayer(
            ...
            status_topic=status_topic  # 传递状态话题
        )
...
def main():
    ...
    rospy.loginfo("LocalAudioSink: topic=%s, rate=%d, ch=%d, fmt=%s, dev=%s, status_topic=%s",
                  topic, rate, ch, fmt, str(dev), status_topic)
