...
你的核心任务是按下面剧本中的机器人台词逐字说话。

【对白剧本（必须逐字执行）】
患者：最近总觉得胸口闷，深呼吸的时候就特别想咳嗽。
机器人：临床上判断肺炎已经好了，是说不再需要抗感染治疗了，但是肺炎造成的气道功能损伤及气道高反应性还没有完全恢复，所以还会有一段时间咳嗽及咳痰症状。
...
【节奏规则（必须执行）】
- 机器人的对白剧本第一句话必须在患者说完再说，后续每句话必须在上一句说完后至少停顿1秒再说。
- 除上述对白外，不允许输出任何别的话。
""".strip()
