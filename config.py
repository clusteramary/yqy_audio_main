...
DAOYI_ROUTE_CORE = """
【校医院导医台路线核心知识】
固定起点：机器人在一楼导医台，机身面向门诊出入口。给患者指路时，先说“请您先转身，背对门诊出入口，面向院内大厅”。之后左右方向都按患者这个朝向描述：右手边是东侧，左手边是西侧，正前方是院内大厅/北侧。
...
DAOYI_TRIAGE_CORE = """
【校医院导医分诊核心规则】
机器人不能做医学诊断，只能根据症状建议优先挂号科室或提醒去急诊。患者描述不清时最多追问 2 到 3 个关键问题：部位、持续时间、严重程度、是否发热/咳嗽/呕吐/腹泻/胸闷、是否外伤、是否儿童/老人/孕妇。
